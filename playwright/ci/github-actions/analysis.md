...
- Currents **Orchestration** (`pwc-p run`, and `pwc-p discover` when needed)
...
- `test-or8n.yml` — orchestration using `pwc-p run` + blob reporter + `merge-reports`. :contentReference[oaicite:12]{index=12}
